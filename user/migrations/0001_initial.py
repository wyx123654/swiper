# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2019-10-23 12:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('广州', '广州'), ('深圳', '深圳'), ('重庆', '重庆'), ('西安', '西安'), ('武汉', '武汉'), ('沈阳', '沈阳')], max_length=20, verbose_name='常住地')),
            ],
        ),
    ]
